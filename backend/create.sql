create table tb_category (id int8 generated by default as identity, created_at TIMESTAMP WITHOUT TIME ZONE, name varchar(255), update_at TIMESTAMP WITHOUT TIME ZONE, primary key (id));
